  ...
  return (
    ...
    <div className="min-h-screen bg-primaryBackgroundColor pt-20">
      <div className="flex w-full pl-2.5 pr-2.5 ">
        <div className="w-3/6 flex items-center justify-center hidden md:block">
          <Image src="/images/connexion.svg" alt="" className="leftDecorationImage" width="500" height="200"/>
        </div>

        <div className="w-full md:w-2/5 p-2.5 bg-white flex flex-col justify-evenly rounded-md">
          <div>
