        ...
        <Dialog 
            ...
            <div className="flex flex-col items-center space-y-6">
                <FileUpload 
                    ...
                    emptyTemplate={
                        <div className="flex flex-col items-center justify-center border-2 border-dashed border-borderGrey bg-light rounded-lg p-6 text-gray-500 cursor-pointer hover:border-primaryColor transition-all">
