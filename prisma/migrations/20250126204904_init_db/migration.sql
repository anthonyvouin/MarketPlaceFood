-- CreateEnum
CREATE TYPE "Role" AS ENUM ('USER', 'ADMIN', 'STOREKEEPER');

-- CreateEnum
CREATE TYPE "RecipeType" AS ENUM ('starter', 'main_dish', 'dessert', 'snack', 'side_dish', 'breakfast', 'beverage');

-- CreateEnum
CREATE TYPE "StatusOrder" AS ENUM ('PAYMENT_FAILED', 'PAYMENT_PENDING', 'PAYMENT_SUCCEDED', 'PREPARING', 'SEND', 'RECEIVED');
